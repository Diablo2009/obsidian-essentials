...
public enum ModArmorMaterials implements ArmorMaterial {
    OBSIDIAN("obsidian", 40, new int[] { 3, 8, 6, 3 }, 35,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2f, 2f, () -> Ingredient.ofItems(ModItems.OBSIDIAN_DUST));
    ...
    public String getName() {
        return ObsidianEssentials.MOD_ID + ":" + this.name;
    }
